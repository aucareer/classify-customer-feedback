...
SERV_ACCT_NAME="report-fn" # need shorter name for service account
APP_NAME="reporting-func"
TOPIC_NAME="feedback-classified"
# Subscription name also becomes the name of the service account representing
# its identity
SUBSCRIPTION_NAME="${SERV_ACCT_NAME}-pubsub-invoker"
...
#      --display-name "Reporting Function Pub/Sub Invoker"
